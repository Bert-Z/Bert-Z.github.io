---
title: '[转载]Linux中apt与apt-get命令的区别与解释'
date: 2020-12-30 07:58:36
tags: linux
categories:
cover: https://img.sysgeek.cn/img/logo/linux/linux-2.jpg
---
...
![img](https://img.sysgeek.cn/img/2017/07/apt-vs-apt-get/2.jpg)

apt 还会在更新存储库数据库时提示用户可升级的软件包个数。

![img](https://img.sysgeek.cn/img/2017/07/apt-vs-apt-get/3.jpg)
